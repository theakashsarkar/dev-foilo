...
{{--                                        <img--}}
{{--                                            src="{{ asset('backend/vendors/images/photo1.jpg')}}"--}}
...
{{--                                    <div class="avatar mr-2 flex-shrink-0">--}}
{{--                                        <img--}}
{{--                                            src="{{ asset('backend/vendors/images/photo2.jpg')}}"--}}
{{--                                            class="border-radius-100 box-shadow"--}}
{{--                                            width="50"--}}
{{--                                            height="50"--}}
{{--                                            alt=""--}}
...
{{--                                    <div class="avatar mr-2 flex-shrink-0">--}}
{{--                                        <img--}}
{{--                                            src="{{ asset('backend/vendors/images/photo3.jpg')}}"--}}
{{--                                            class="border-radius-100 box-shadow"--}}
{{--                                            width="50"--}}
{{--                                            height="50"--}}
{{--                                            alt=""--}}
...
{{--                                    <div class="avatar mr-2 flex-shrink-0">--}}
{{--                                        <img--}}
{{--                                            src="{{ asset('backend/vendors/images/photo4.jpg')}}"--}}
{{--                                            class="border-radius-100 box-shadow"--}}
{{--                                            width="50"--}}
{{--                                            height="50"--}}
{{--                                            alt=""--}}
...
{{--                        <img src="{{ asset('backend/vendors/images/upgrade.svg')}}" alt="" />--}}
{{--                    </div>--}}
...
{{--                            <div class="avatar mr-2 flex-shrink-0">--}}
{{--                                <img--}}
{{--                                    src="{{ asset('backend/vendors/images/photo5.jpg')}}"--}}
{{--                                    class="border-radius-100 shadow"--}}
{{--                                    width="40"--}}
{{--                                    height="40"--}}
{{--                                    alt=""--}}
...
{{--                            <div class="avatar mr-2 flex-shrink-0">--}}
{{--                                <img--}}
{{--                                    src="{{ asset('backend/vendors/images/photo6.jpg')}}"--}}
{{--                                    class="border-radius-100 shadow"--}}
{{--                                    width="40"--}}
{{--                                    height="40"--}}
{{--                                    alt=""--}}
...
{{--                            <div class="avatar mr-2 flex-shrink-0">--}}
{{--                                <img--}}
{{--                                    src="{{ asset('backend/vendors/images/photo9.jpg')}}"--}}
{{--                                    class="border-radius-100 shadow"--}}
{{--                                    width="40"--}}
{{--                                    height="40"--}}
{{--                                    alt=""--}}
...
{{--                            <div class="avatar mr-2 flex-shrink-0">--}}
{{--                                <img--}}
{{--                                    src="{{ asset('backend/vendors/images/photo8.jpg')}}"--}}
{{--                                    class="border-radius-100 shadow"--}}
{{--                                    width="40"--}}
{{--                                    height="40"--}}
{{--                                    alt=""--}}
